...
type TransactionForFrontend = ReturnType<
	typeof transformTransactionForFrontend
>;
...
export default function TransactionsPage() {
	...
	const handleCreateTransaction = async () => {
		...
		if (!isValid) {
			const errorMessage =
				clientErrorHandler.handleFormValidationErrors(errors);
			toast.error(errorMessage);
			return;
		}
		...
		try {
			...
			if (process.env.NODE_ENV === "development") {
				...
				console.log("💡 복구 제안:", recoveryActions);
			}
					...
					<ModalBody>
						<div className="space-y-4">
							...
							<ValidatedInput
								...
								onValueChange={(value) =>
									createForm.updateField("amount", value)
								}
